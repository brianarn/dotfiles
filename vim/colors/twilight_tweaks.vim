" Vim color file
" Converted from Textmate theme Twilight Tweaks using Coloration v0.2.4 (http://github.com/sickill/coloration)
...
hi Pmenu  guifg=#af7e46 ctermfg=137 guibg=NONE gui=NONE
...
hi Function  guifg=#af7e46 ctermfg=137 guibg=NONE gui=NONE
...
hi rubyFunction  guifg=#af7e46 ctermfg=137 guibg=NONE gui=NONE
...
hi yamlKey  guifg=#af7e46 ctermfg=137 guibg=NONE gui=NONE
...
hi cssPseudoClassId  guifg=#af7e46 ctermfg=137 guibg=NONE gui=NONE
hi cssClassName  guifg=#af7e46 ctermfg=137 guibg=NONE gui=NONE
